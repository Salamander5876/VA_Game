...
'tutorial_end': {
    ...
    story: [
        ...
        { speaker: 'Володя', text: 'Помни, здесь нет "правильных" или "неправильных" людей, есть только разные **точки зрения**.' },
    ...
    choices: [
        { text: 'Начать Ситуацию 1 (Взгляд Вожатого)', nextScene: 'scene1' }
    ]
},
